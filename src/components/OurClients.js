function OurClients () {
    return(
        <>
        <section class= "clients_index">
        <h2>Our Clients</h2>
        
        <p>Trusted and Loved by</p>
        </section>
        
        <section class="clients_logo">
       
         <div>
             <img src="https://kwanjaiservices.com/wp-content/uploads/2020/01/sarin-city.png" alt="client1" class="clients"/>
         </div>
         
         <div>
            <img src="https://makeupbydesign.ca/wp-content/uploads/2020/07/marika-magazine-logo-275x275-1.png" alt="client2" class="clients"/>
         </div>

         <div>
           <img src="https://d1fdloi71mui9q.cloudfront.net/SVDJcKMLRWSCGSKTjwVN_1976cda9e0a0a931b2ca2148ef63f2e8.png" alt="client3" class="clients"/>
         </div>
